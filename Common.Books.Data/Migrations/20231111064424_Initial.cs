        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookRequestStatus = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PromptResponse = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookPreviews_BookRequests_BookRequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookPreviewId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    GptResponse = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Books_BookPreviews_BookPreviewId",
                        column: x => x.BookPreviewId,
                        principalTable: "BookPreviews",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Books_BookRequests_BookRequestId",
                        column: x => x.BookRequestId,
                        principalTable: "BookRequests",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookPreviews_BookRequestId",
                table: "BookPreviews",
                column: "BookRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_Books_BookPreviewId",
                table: "Books",
                column: "BookPreviewId");

            migrationBuilder.CreateIndex(
                name: "IX_Books_BookRequestId",
                table: "Books",
                column: "BookRequestId");
